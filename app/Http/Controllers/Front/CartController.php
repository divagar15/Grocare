...
class CartController extends Controller {
    ...
    public function cart(Request $request)
    {
        ...
        return view('front/checkout/cart')->with(array('pageTitle'=>$pageTitle,'orderSession'=>$orderSession, 
            'orderProducts'=>$orderProducts, 'countries'=>$this->countries, 'couriers'=>$couriers, 
...
if(Session::has('referrer')) {
	$orderSession->referrer = Session::get('referrer');
}
            $orderSession->save();
