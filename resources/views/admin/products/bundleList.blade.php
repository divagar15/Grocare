...
@section('content')     	
<div class="page-header"><h1>Bundle Products</h1></div>
...
<div class="row">
              ...
              <div class="col-md-12">
                  <div class="panel panel-default">
                        <div class="panel-heading"><a href="{{URL::to('admin/catalog/product/add/bundle')}}" class="btn btn-sm btn-primary">Add Bundle Product</a></div>
                                ...
                                @if(isset($products) && !empty($products))
                                  ...
                                  @foreach($products as $product)
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                          <a class="btn btn-xs btn-info" href="{{URL::to('admin/catalog/product/bundle/edit/'.$product->id)}}">Edit</a> 
