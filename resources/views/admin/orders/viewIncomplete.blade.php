...
<a href="javascript:void(0)" id="closeBilling" name="submit" class="btn btn-sm btn-default billing-btn">Close</a>
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <dl>
                          ...
                          <dd>Order Date : @if($orderDetail->order_placed_date!=NULL){{date('d-m-Y H:i:s',strtotime($orderDetail->order_placed_date))}}@else{{date('d-m-Y H:i:s',strtotime($orderDetail->created_at))}}@endif</dd>
                        </dl>
