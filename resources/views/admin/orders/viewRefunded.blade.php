...
<a class="btn btn-sm btn-info" href="{{URL::to('admin/orders/edit-ordered-items/'.$orderSession->id.'/'.$orderDetail->id)}}">Edit Order</a>
<div class="row">
                ...
                <hr>
                    ...
                    <div class="col-md-6">
                        ...
                        <address class="billing_text">
                          ...
                          <abbr title="Phone">P:</abbr> {{$orderAddress->billing_phone}}
                        </address>
...
<a href="javascript:void(0)" id="closeBilling" name="submit" class="btn btn-sm btn-default billing-btn">Close</a>
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <address class="shipping_text">
                          ...
                          @if(!empty($orderAddress->shipping_phone))<abbr title="Phone">P:</abbr> {{$orderAddress->shipping_phone}}<br>@endif
...
<td>@if(!empty($orderDetail->payment_type)){{$paymentType[$orderDetail->payment_type]}}@endif</td>                          </tr>
                         ...
                         <!--  <tr>
                              ...
                              <td style="text-align:center;" colspan="3"><a class="btn btn-sm btn-warning" href="{{URL::to('admin/orders/edit-ordered-items/'.$orderSession->id.'/'.$orderDetail->id)}}">Edit Items</a></td>
...
<div class="form-group refundAmt">
...
<div class="form-group">
<input type="hidden" name="page" value="refunded">
           ...
           $('#refund_amount').keyup(function() {
            ...
            $(document).on('click',".removeTracking",function (){   
                ...
                if(type=='dynamic') { 
                  ...
                  if(confirmMsg) {
                    window.location = "{{URL::to('admin/orders/remove-tracking/refunded/'.$orderDetail->id)}}/"+id;
                  }
                }
            });
            ...
            $(document).on('click',".removeNote",function (){   
                  ...
                  if(confirmMsg) {
                    window.location = "{{URL::to('admin/orders/remove-note/refunded/'.$orderDetail->id)}}/"+id;
                  }
            });
