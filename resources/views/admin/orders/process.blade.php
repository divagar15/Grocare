...
@section('content')     	
<div class="page-header"><h1>New / Processing Orders</h1></div>
                                ...
                                @if(isset($orderDetails) && !empty($orderDetails))
                                  ...
                                  @foreach($orderDetails as $detail)
                                    ...
                                    <tr>
                                      ...
                                      <td>{{$detail->order_symbol}} {{round($detail->grand_total)}}</td>
                                      <td>{{$orderStatus[$detail->order_status]}}</td>
                                      <td>
                                          <a class="btn btn-xs btn-info" href="{{URL::to('admin/orders/process/'.$detail->id)}}">View</a> 
                                      </td>
                                    </tr>
