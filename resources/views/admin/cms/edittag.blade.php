...
@section('content')     	
<div class="page-header"><h1>Edit Tag Links</h1></div>


<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			 <div class="panel-heading">Edit Tag Links</div>
				...
				<form id="edittag_form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
					<div id="row_1">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" name="title" id="title" class="form-control" value="{{$cms_taglinks->title}}">
							</div>
						</div>	
						<br/><br/><br/>
						<div class="form-group">
