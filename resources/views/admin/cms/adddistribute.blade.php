...
@section('content')     	
<div class="page-header"><h1>Add Distribute</h1></div>
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			 <div class="panel-heading">Add Distribute</div>
			 <div class="panel-body">
				<form id="adddistribute_form" class="form-horizontal" role="form" method="post">
...
<script type="text/javascript">
	function validate(){
		var action = '{{URL::to('admin/cms/adddistribute')}}';
		$( "#adddistribute_form" ).attr('action', action);
		$( "#adddistribute_form" ).submit();
		return true;		
	}
</script>
