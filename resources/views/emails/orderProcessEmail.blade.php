...
<body>
		...
		<div id="bodyHeader" style="background: #06ACF4; border-top-left-radius:10px; border-top-right-radius:10px; 
			...
			<h2 style="color:#fff;
				...
				margin-top: 0px;
				padding-top: 25px;
				font-size: 25px;">Diet Chart</h2>
		</div>
		<p style="padding-left: 15px; padding-right: 15px;">Dear {{ucfirst($name)}},</p>
		<p style="padding-left: 15px; padding-right: 15px;">Thank you for your order with Grocare India.</p>
		<div style="padding-left: 15px; padding-right: 15px;"><?php echo $die_chart_content;?></div>
		<br/>
