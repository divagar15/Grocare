	...
	<div style="background-color: #f5f5f5; padding-top:20px; padding-bottom:20px;"> 
		...
		<div id="bodyHeader" style="background: #06ACF4; border-top-left-radius:10px; border-top-right-radius:10px; 
			...
			<h2 style="color:#fff;
				...
				margin-top: 0px;
				padding-top: 25px;
				font-size: 25px;">Account Confirmation</h2>
		</div>

		<p style="padding-left: 15px; padding-right: 15px;">Hello Grocare-ian,</p>
		<p style="padding-left: 15px; padding-right: 15px;">Thanks for registering with Grocare India.</p>
		<p style="padding-left: 15px; padding-right: 15px;">To login please visit the following URL: <a href="{{URL::to('auth/login')}}">Click here to login</a></p>
