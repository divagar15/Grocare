...
<div class="row" id="aboutUs">
  <div class="col-md-12"> <h1 class="titleh2"><?php if($cms_eval->title != ""){ echo trim($cms_eval->title, '{}'); } ?></h1>
...
<div class="row" id="slogan">
	...
	<div class="col-md-4" style="height: 400px;">
		...
		<div class="titleh5">{{$cms_taglinks->title}}</div>
...
<div class="row" style="margin-top:10px;">
  ...
  <div class="col-md-12">
   ...
   <!--<div class="titleh5 text-center">ALL OF THESE AMAZING THINGS, AND SUCH NOMINAL COSTS</div>
