      ...
      <div class="col-md-3">
          ...
          <div class="productGrid">
            <a href="{{URL::to('products/'.$list->product_slug)}}">
                ...
                <img src="{{URL::asset('public/uploads/products/'.$list->id.'/'.$list->feature_image)}}" class="img-responsive loading" style="padding-top:15px;">
                <img src="{{URL::asset('public/front/images/loader.gif')}}" id="loader{{$list->id}}" class="loading-gif">
				</div>
                        ...
                        data:{product_id:product_id,product_price:product_price,product_type:product_type,product_course:product_course,product_qty:product_qty,ordered_from:ordered_from,add_type:1},
                            ...
                            if(response!=2) {
                                ...
                                $.gritter.add({
                                    ...
                                    text: 'Please click on the cart to view',
                                    class_name: 'success',
                                    time: '3000'
                                });
