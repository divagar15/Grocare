...
<div class="row">
  ...
  <h1 class="titleh1 centralize">{{ucwords($productDetail->name)}}</h1>
  ...
  <div class="col-md-12" id="productTabDetail">
    ...
    <a href="{{URL::to('products/'.$productDetail->product_slug)}}" class="white order-color">What it is?</a> <a href="{{URL::to('products/'.$productDetail->product_slug.'/contents')}}" style="margin-left:30px;"  class="white order-color">Contents</a>
      ...
      <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="productTitleBlock">
              ...
              <div class="titleh5">{{ucwords($tiles->title)}}</div>
