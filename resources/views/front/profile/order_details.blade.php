   ...
   @if(Session::has('success_msg'))
	...
	<div class="col-md-12 no-padding">
		...
		<div class="col-md-9">
			...
			<div class="margin-null titleh3">Order Details</div>
			 ...
			 <div class="col-md-12 no-padding order-content">
						  ...
						  <div class="col-md-6 nopadding">
								  ...
								  <div class="margin-null titleh3">Customer details</div>
						...
						<p><strong>Phone:</strong> {{$orderAddress->billing_phone}}</p>
						  ...
						  <div class="col-md-6 nopadding">
								  ...
								  <div class="margin-null titleh3">Invoice Details</div>
						...
						<p><strong>Payment Type  :</strong> {{$payment_text}}</p>
						 ...
						 <div class="col-md-12">
							...
							<tr>
							  ...
							  <th><div class="margin-null titleh3">Billing Address</div></th>

							  <th><div class="margin-null titleh3">Shipping Address</div></th>
					  ...
					  <div class="col-md-12">
						  ...
						  <div class="margin-null titleh3">Order Tracking Details</div>

							@if($couriers)

								<div class="col-md-12 bottom2">

									<div class="col-md-4 "><div class="margin-null titleh4">Selected Courier :</div></div><div class="col-md-8 ">{{$couriers->name}}</div>							
							...
							@if(count($orderTracking)>0)
								...
								<div class="col-md-12 bottom2">
									...
									<div class="col-md-4 "><div class="margin-null titleh4">Tracking Numbers :</div></div><div class="col-md-8 ">
