	...
	<div id="content" class="container">
		...
		<div class="row">
			...
			<div class="main col-md-12" role="main">
				...
				<h2 class="titleh1" style="text-align: center;"><?php if($cms_eval->headtitle != ""){ echo trim($cms_eval->headtitle, '{}'); } ?></h2>
				...
				<div class="titleh2" style="text-align: center;">

					<div class="space_40 clearfix"></div>

				</div>

				<div class="titleh3" style="text-align: center;">Help Us, Help You</div>
