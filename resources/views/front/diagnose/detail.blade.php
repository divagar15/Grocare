...
<style type="text/css">
  ...
  .diagnonsis-product img {
	...
	.owl_testimonials .owl-controls {width: 98%;height:95%;}
	.owl_testimonials .owl-prev{position: absolute;left: 0px;top:40%;}
	.owl_testimonials .owl-next{position: absolute;right: 0px;top:40%;}
...
/*	#diagnosis-testimonials audio{position:absolute;}
	.owl_testimonials .item p{position: relative !important;top: 36px;}*/
</style>
...
<div class="row centralize">
  ...
  <div class="col-md-12 content">
      ...
      <div class="col-xl-2 col-md-2 col-sm-4">
        ...
        <p><a href="#orderMenu" id="orderMenu2" class="btn btn-default btn-sm tabBtn customGradientBtn full-width white order-color order_black orderBtn">ORDER NOW</a></p>	
      </div>
  ...
  @if(!empty($diagnosisDetail->how_is_it_caused))
    ...
    <div class="productTitleBlock">
      ...
      <div class="titleh3">How is it caused?</div>
...
@if(!empty($diagnosisDetail->how_to_heal_naturally))
    ...
    <div class="productTitleBlock">
      ...
      <div class="titleh3">How to heal naturally?</div>
...
@if(!empty($diagnosisProduct))
  ...
  @foreach($diagnosisProduct as $keyval=>$diaPro)
      ...
      <div class="col-md-4 col-sm-offset-{{$offsetPro}} diagnonsis-product">
        ...
        <!-- <div class="titleh3">{{ucwords($diaPro->name)}}</div> -->
        ...
        <p style="margin-top:10px; margin-bottom:10px;"><a class="@if($diaPro->key_ingredients!='')  @endif btn btn-default btn-sm tabBtn customGradientBtn white" @if($diaPro->key_ingredients!='') href="{{URL::to('products/'.$diaPro->product_slug.'/contents')}}" target="_blank"  @else href="javascript:void(0)" @endif >CONTENTS</a></p>
...
@if(!empty($diagnosisDetail->how_it_works))
    ...
    <div class="productTitleBlock">
      ...
      <div class="titleh3">How it works?</div>
		<div class="hrule clearfix"></div>
...
@if(!empty($diagnosisBlock))
  ...
  @foreach($diagnosisBlock as $diaBlock)
    ...
    <div class="productTitleBlock">
      ...
      <div class="titleh3">{{$diaBlock->title}}</div>
		<div class="hrule clearfix"></div>
...
<div class="titleh3">Testimonials</div>

<div id="diagnosis-testimonials" class="owl-carousel owl_testimonials">
...
<div class="row" id="tagline">
      <div class="col-md-12">
        ...
        <div class="col-md-2 col-md-offset-{{$offset}}">
          ...
          <div class="size15 titleh5 sizeh5">NO ADDED<br/>CHEMICALS</div>
          <?php $offset = 0; ?>
        </div>
        @endif
        @if($diagnosisDetail->no_dietary_restrictions==1)
        <div class="col-md-2 col-md-offset-{{$offset}}">
          ...
          <div class="size15 titleh5 sizeh5">NO DIETARY<br/>RESTRICTIONS</div>
          <?php $offset = 0; ?>
        </div>
        @endif
        @if($diagnosisDetail->fda_approved==1)
...
<!-- <p><strong>Note:</strong><span> Full Treatment is for 6 months. However, you may choose to purchase the treatment in parts as per your convenience</span></p>
 -->    </div>
    ...
    <div class="col-md-4" id="priceSection">
	  ...
	  <a href="{{URL::to('contact')}}#contactDistributor" class="text-right call_btncircle"><span><strong>CONTACT US</strong></span><img src="{{URL::asset('public/front/images/blue-30.png')}}" /></a>
	 <br/> </div>
...
<div class="titleh5" style="font-weight:bold; font-size:18px;">PRICE : {{$symbol}} {{$displayPrice}} For {{$displayCourse}}</div>
...
@if($activeCountry=='IN')
       ...
       @if($shippingCharge->minimum_amount>0 && $shippingCharge->minimum_amount!=0.00)
        <p style="font-size:16px;"><i>Free shipping for order amount above {{$symbol}} {{round($shippingCharge->minimum_amount)}}</i></p>
       @endif
	   
@endif

    <p><!--<a href="#contactUsForm" class="inline2 btn btn-default btn-sm orderBtn customGradientBtn white order-color">Contact Us</a>-->
	   <a href="javascript:void(0)" id="orderMenu" class="btn btn-default btn-sm orderBtn customGradientBtn white order-color orderBtn">ORDER NOW</a></p>
	<?php 
    $courseStart = 0;
  ?>
...
<script type="text/javascript">
  $(document).ready(function(){
     ...
     $(".iframevideo").colorbox({iframe:true, innerWidth:840, innerHeight:450});
	  ...
	  $('.owl-prev').html("<img src={{URL::to('public/front/images/left.png')}} />" );
	 // $('.owl-prev').html("<i class="fa fa-chevron-right"></i>" );
	  $('.owl-next').html("<img src={{URL::to('public/front/images/right.png')}} />" );
