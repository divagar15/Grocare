...
<script>(function(d, s, id) {
  ...
  <div style="display: none;" id="dialog" class="window">
    <div id="lorem">
	 ...
	 <div style="padding:5%;"> 
      <h3 style="font-weight:bold; font-size:28px;">We are updating our servers to improve customer experience. Please bear with us for 24 hours.</h3>
    </div>
    </div>
