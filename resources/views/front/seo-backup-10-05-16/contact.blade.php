...
<div class="row" id="contactAddress">
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-3">
      ...
      <div class="col-md-10">
        <h4>Helpline<br/><?php if($cms_eval->helplineno != ""){ echo trim($cms_eval->helplineno, '{}'); } ?></h4>
    ...
    <div class="col-md-3">
      ...
      <div class="col-md-2 image-icons">
		<i class="fa fa-fax fa_fax"></i>
        <!--<img src="{{URL::asset('public/front/images/icons/fax.png')}}" />-->
      </div>

      <div class="col-md-10">
        <h4>Fax<br/><?php if($cms_eval->faxno != ""){ echo trim($cms_eval->faxno, '{}'); } ?></h4>
      </div>
