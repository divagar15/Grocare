...
@endif
  ...
  <h2>Thank you for your order</h2>
    <p>Your order has been received. Your order details are shown below for your reference:</p>
		<p>Please deposit the amount into our bank account as mentioned below. After deposit, please send a confirmatory email or SMS or whatsapp on +91 98221 00031, giving your order Ref. No.</p>
<p>Your order won’t be shipped until the funds have been deposited in our account.</p>
    
    <div class="titleh3">Our Bank Details</div>
    <div class="titleh4">{{$bankDetails->account_name}}</div>
    ...
    <div class="titleh3">Order: {{$orderDetail->invoice_no}}</div>
  ...
  <div class="col-md-12" id="cartCalculation" style="margin-top:20px;">
      ...
      <div class="col-md-6 nopadding">
              <div class="titleh3">Customer details</div>
...
<tr>
  <th><div class="titleh3">Billing Address</div></th>
  <th><div class="titleh3">Shipping Address</div></th>
</tr>
