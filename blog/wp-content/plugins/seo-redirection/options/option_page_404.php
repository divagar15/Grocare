...
<?php
	...
	$grid->add_php_col(' echo " <a target=\'_blank\' href=\'" . SEOR_make_absolute_url($db_link) ."\'> " .SR_cut_string($db_link,0,50) ."</a>" ;','Link');
	...
	$grid->add_template_col('redirect_link','?page=' . $util->get('page') . '&tab=cutom&add=1&page404={db_ID}','Redirect');
