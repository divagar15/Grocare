<?php
/*
    Plugin Name: Optin Cat Business
    Plugin URI: https://fatcatapps.com/optincat
    Description: Optin Cat Business Lets You Build Highly Converting Email Optin Forms In Minutes.
    Author: Fatcat Apps
    Version: 1.6.3
...
define( 'FCA_EOI_EDITION', 'optin_cat_business' );
