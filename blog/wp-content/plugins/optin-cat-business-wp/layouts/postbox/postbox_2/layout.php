...
$layout = array(
	...
	'editables' => array(
		...
		'headline' => array(
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_headline_copy_wrapper' => array(
				'font-weight'      => array( '', 'bold' ),
				'font-style'       => array( '', 'italic' ),
				'text-decoration'  => array( '', 'underline' ),
				'font-size'        => array( __( 'Font Size' ), '20px' ),
			),
			'.fca_eoi_postbox_2 .ribbon' => array(
				'color'            => array( __( 'Font Color' ), '#FFF' ),
				'background-color' => array( __( 'Background Color' ), '#3197e1' ),
			),
			'.fca_eoi_postbox_2 .ribbon .ribbon-content:before, .fca_eoi_postbox_2 .ribbon .ribbon-content:after' => array(
		...
		'description' => array(
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_description_copy_wrapper' => array(
		...
		'name_field' => array(
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_name_field_wrapper' => array(
				'background-color' => array( __('Background Color') , '#FFF' ),
				'border-color' => array( __('Border Color') , '#FFF' ),
			),
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_name_field_wrapper input, .fca_eoi_postbox_2 .fca_eoi_postbox_2_name_field_wrapper .fa' => array(
				'color' => array( __('Font Color') , '#000' ),
			),
		),
		...
		'email_field' => array(
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_email_field_wrapper' => array(
				'background-color' => array( __('Background Color') , '#FFF' ),
				'border-color' => array( __('Border Color') , '#FFF' ),
			),
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_email_field_wrapper input, .fca_eoi_postbox_2 .fca_eoi_postbox_2_email_field_wrapper .fa' => array(
				'color' => array( __('Font Color') , '#000' ),
			),
		),
		...
		'button' => array(
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_submit_button_wrapper input' => array(
		...
		'privacy' => array(
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_privacy_copy_wrapper' => array(
		...
		'fatcatapps' => array(
			'.fca_eoi_postbox_2 .fca_eoi_postbox_2_fatcatapps_link_wrapper a, .fca_eoi_postbox_2 .fca_eoi_postbox_2_fatcatapps_link_wrapper a:hover' => array(
